$( document ).ready(function() {
    ...
    let imageListWrapper = document.createElement("ul"),
    ...
    request.onreadystatechange = function() {
        ...
        if ( request.status === 200 && request.readyState === 4) {
            ...
            const sliderDate = JSON.parse(request.responseText);

            // Slider content data function
            function sliderDateSet(index) {
            ...
            /*-- For loop --*/
            for( let i=0; i <= sliderDate.length-1; i++ ){
